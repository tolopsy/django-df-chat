...
class MessageImageSerializer(serializers.ModelSerializer):
    ...
    message_id = HashidSerializerCharField(
        source_field="chat.MessageImage.id", required=False
    )
    room_id = HashidSerializerCharField(source_field="chat.Room.id", required=False)
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    parent_id = HashidSerializerCharField(
        source_field="chat.Message.id", required=False
    )
